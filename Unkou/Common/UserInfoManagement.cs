...
namespace Unkou.Common
{
    public partial class UserInfoManagement
    {
        ...
        /// 権限レベル
        /// </summary>
        //public static Common.FixedCd.AuthLevel authLevel = authLevel.non;
        /// <summary>
        /// 権限データ
        /// </summary>
        /// <remarks>ログイン時取得した全メニュー分の権限情報</remarks>
        public static DataTable authData = default;
        ...
        /// テスト（練習環境）フラグ
        /// </summary>
        //public static TestFlgType testFlg = TestFlgType.normalUser;
        /// <summary>
        /// 発行バージョン
        /// </summary>
